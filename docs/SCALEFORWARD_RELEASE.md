# PHARPRO ScaleForward Release Brief

Release date: 2026-08-29  
Source: `Pharpro Scaleforward 1_1 Marc Wullings - 2026_08_10 13_59 CEST - Notulen gemaakt door Gemini.docx`

## Outcome

This release turns the meeting notes into a defensible, human-centred conversion path for PHARPRO and PHARPRO DVS. It keeps a detailed 30-minute product evaluation for qualified buyers while adding a lower-friction three-field request for a free 10-minute fit check with a named practitioner.
...
| Add personal/team photos and contact information | Reused `images/ceo_photo.webp`; added email, WhatsApp and LinkedIn. No additional team photos were supplied in the DOCX | Founder complete; team-photo dependency open |
...
| Release branch | `codex/scaleforward-human-trust` |
...
The existing worktree already contained extensive uncommitted PHARPRO changes. This release does not squash, reset or overwrite that history. A standalone unified patch is supplied as `PHARPRO-ScaleForward.patch` beside the release archive.
...
3. `fix(a11y): expose form status and FAQ expanded state`
4. `test(release): add ScaleForward trust and deployment checks`
5. `docs(release): add staging, QA, credential and rollback runbook`
...
2. Request recrawl of `/`, `/services/dvs/`, `/about/` and `/about/mohammad-awawdeh/`.
...
- ScaleForward automated release validator.
...
- Provide approved team portraits if more than the founder should be shown.
- Provide written client permissions, exact approved quotations, logo files and measurable case-study baselines/outcomes.
