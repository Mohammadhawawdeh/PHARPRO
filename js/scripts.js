...
const translations = {
  en: {
    ...
    dvs_p:        "Validation-specific software for pharmaceutical teams, with AI-assisted drafting, requirements traceability and controlled review workflows.",
    ...
    about_p2:      "We also offer PHARPRO DVS, an AI-assisted validation software platform for connected documents, requirements traceability, controlled review and approval workflows.",
    about_p3:      'Every service is delivered by practising consultants — not generalist trainers. <a href="/about/" style="color:#B12C4B;font-weight:600;">Learn about PHARPRO and its leadership →</a>',
    about_p4:      "",
  },
  ...
  ar: {
    ...
    about_p2:      "نقدم أيضاً PHARPRO DVS، منصة تحقق بمساعدة الذكاء الاصطناعي للوثائق المترابطة وتتبع المتطلبات وسير عمل المراجعة والاعتماد المنضبط.",
    about_p3:      '<a href="/about/" style="color:#B12C4B;font-weight:600;">تعرّف على PHARPRO وقيادتها →</a>',
    about_p4:      "",
  }
};
