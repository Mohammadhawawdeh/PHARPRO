  ...
  upcoming: [
    {
      ...
      desc_en: "Full CSV lifecycle from URS to IQ/OQ/PQ — aligned with FDA 21 CFR Part 11 and GAMP 5.",
      desc_ar: "دورة حياة CSV الكاملة من URS إلى IQ/OQ/PQ — وفقاً لـ FDA 21 CFR Part 11 وGAMP 5.",
      format: "both",
    },
    {
      en: "Compressed Air Testing",
      ar: "اختبار الهواء المضغوط",
      desc_en: "ISO 8573 pharmaceutical compressed air testing — sampling strategies, risk assessment, and GMP documentation.",
      desc_ar: "اختبار الهواء المضغوط الدوائي وفق ISO 8573 — استراتيجيات أخذ العينات وتوثيق GMP.",
      format: "both",
    },
    {
      en: "GMP Training",
      ar: "تدريب GMP",
      desc_en: "Core GMP principles covering regulatory expectations, data integrity, CAPA, and audit readiness.",
      desc_ar: "مبادئ GMP الأساسية — التوقعات التنظيمية وسلامة البيانات والاستعداد للتدقيق.",
      format: "both",
    },
    {
      en: "Cleaning Validation",
      ar: "التحقق من التنظيف",
      desc_en: "EU GMP Annex 15 cleaning validation — MACO calculations, acceptance criteria, and sampling strategies.",
      desc_ar: "التحقق من التنظيف وفق EU GMP Annex 15 — حسابات MACO ومعايير القبول واستراتيجيات أخذ العينات.",
      format: "both",
    },
    {
      en: "Thermal Mapping Training",
      ar: "تدريب الخرائط الحرارية",
      desc_en: "Thermal mapping qualification for warehouses and cold rooms — aligned with WHO, EU GMP, and ASHRAE.",
      desc_ar: "تأهيل الخرائط الحرارية للمستودعات والغرف الباردة — وفق معايير WHO وEU GMP وASHRAE.",
      format: "both",
    },
    {
      en: "Good Supply & Distribution Practice (GSDP)",
      ar: "ممارسات التوريد والتوزيع الجيدة (GSDP)",
      desc_en: "GDP/GSDP regulations for pharma distribution — cold chain, storage conditions, and documentation.",
      desc_ar: "لوائح GDP/GSDP لتوزيع الأدوية — إدارة سلسلة التبريد وظروف التخزين والتوثيق.",
      format: "both",
    },
    {
      en: "Quality Culture Training",
      ar: "تدريب ثقافة الجودة",
      desc_en: "Human error prevention, behavioural GMP, and right-first-time compliance principles.",
      desc_ar: "الوقاية من الخطأ البشري وGMP السلوكي ومبادئ الصواب من أول مرة.",
      format: "both",
    },
    {
      en: "Data Integrity Training",
      ar: "تدريب سلامة البيانات",
      desc_en: "ALCOA+ principles and FDA/MHRA expectations — audit trail review and computerised system controls.",
      desc_ar: "مبادئ ALCOA+ وتوقعات FDA وMHRA — مراجعة مسارات التدقيق وضوابط الأنظمة الحاسوبية.",
      format: "both",
    },
    {
      en: "Medical Devices — ISO 13485",
      ar: "الأجهزة الطبية — ISO 13485",
      desc_en: "ISO 13485:2016 QMS for medical devices — risk management, design controls, and traceability.",
      desc_ar: "ISO 13485:2016 لمصنّعي الأجهزة الطبية — إدارة المخاطر وضوابط التصميم والتتبعية.",
      format: "both",
    },
    {
      en: "EU GMP Annex 1 Training",
      ar: "تدريب EU GMP الملحق 1",
      desc_en: "2022 revised Annex 1 for sterile products — contamination control strategy, cleanroom design, and monitoring.",
      desc_ar: "المراجعة 2022 لـ Annex 1 — استراتيجية التحكم في التلوث وتصميم غرف النظافة والمراقبة البيئية.",
      format: "both",
    },
    {
      en: "Environmental Monitoring — ISO 14644",
      ar: "المراقبة البيئية — ISO 14644",
      desc_en: "ISO 14644 cleanroom classification — particle counting, microbial monitoring, and EM trending.",
      desc_ar: "تصنيف غرف النظافة وفق ISO 14644 — عد الجسيمات والمراقبة الميكروبية واتجاهات EM.",
      format: "both",
    },
  ],
  completed: [
